...
import (
	...
	"github.com/gomatic/opinionated/client"
	"github.com/gomatic/opinionated/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "opinionated-cli",
		Short: `CLI client for the opinionated service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "localhost:3080", "API hostname")
